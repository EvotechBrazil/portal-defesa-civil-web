    ...
    <Card>
      ...
      {reset.isSuccess ? (
        <div className="mt-6 space-y-4">
          ...
          <Link
            href="/login"
            className="inline-flex w-full cursor-pointer items-center justify-center rounded-md bg-flare px-4 py-2 text-sm font-medium text-white transition hover:bg-flare/90"
          >
        ...
        <div className="mt-6 space-y-4">
          ...
          <p className="text-center text-sm text-mist">
            <Link href="/esqueci-senha" className="font-medium text-flare underline">
